# module_13/app.py
# =============================================
# MODULE 13: SECURE LOGGING (SHA-256)
...
MODULE_NAME = "Module_13_Secure_Logging"
PORT        = 5013
...
# POST /api/module13/verify-log
# GET  /api/module13/integrity-report
# =============================================

# EXAMPLE endpoint — replace with your actual implementation
@app.route("/api/module13/example", methods=["POST"])
@jwt_required
...
if __name__ == "__main__":
    print(f"🔐 Module 13 — Secure Logging (SHA-256) running on port {PORT}")
